...
plt.ylim(-0.2,1); plt.yticks(np.arange(-0.2,1.4,0.2))
plt.xlabel('F(t) [V]')
plt.ylabel('t [s]')
...
fg1.savefig('sistema musculoesqueletico Lazo abierto python.pdf')
...
plt.plot(t,Pp1,'-',linewidth=1,color= clr2,label= 'Fs2. Caso')
plt.plot(t,u,'-',linewidth=1,color=clr3,label= 'Fs. Impulso')
plt.plot(t,Pp3,'--',linewidth=1,color= clr4,label= 'Tratamiento')
